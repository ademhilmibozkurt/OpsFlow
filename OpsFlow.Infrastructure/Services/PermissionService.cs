...
namespace OpsFlow.Infrastructure.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public void CanGetIncidentTasks(string createdById, string userId, string userRole)
        {
            if (createdById == userId)
            {
                return;
        ...
        public void CanGetTaskHistory(string createdById, string userId, string userRole)
        {
            if (createdById == userId)
            {
                return;
        ...
        public void CanGetUserActivity(string userRole)
        {
            if (userRole != "Admin")
            {
